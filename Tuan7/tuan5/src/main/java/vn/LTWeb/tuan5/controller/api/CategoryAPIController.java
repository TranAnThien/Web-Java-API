...
//lưu file vào trường Images
                category.setImages(storageService.getSorageFilename(icon, uuString));
...
//kiểm tra tồn tại file, lưu file
            if(!icon.isEmpty()) {
                ...
                String uuString = uuid.toString();
//lưu file vào trường Images
                optCategory.get().setImages(storageService.getSorageFilename(icon, uuString));
                storageService.store(icon, optCategory.get().getImages());
            }
